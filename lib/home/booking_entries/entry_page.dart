...
import 'package:visbooking_app/home/booking_entries/date_time_picker.dart';
...
class EntryPage extends StatefulWidget {
  const EntryPage(
      {@required this.database, @required this.booking, this.entry});
  ...
  static Future<void> show(
    ...
    await Navigator.of(context, rootNavigator: true).push(
      MaterialPageRoute(
        builder: (context) =>
            EntryPage(database: database, booking: booking, entry: entry),
